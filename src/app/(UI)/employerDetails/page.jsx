            ...
            <div className='bg-gray-100 flex  justify-between p-10'>
                <div className='flex gap-x-6'>
                    ...
                    <div className='space-y-2'>
                        <h1 className='text-2xl'>Mukianso IT Sulution Ltd.</h1>
                        ...
                        <div className='flex gap-4'>
                            <button className='bg-green-600 hover:bg-white mt-2 hover:text-black border border-green-600 text-white px-4 py-2 rounded-md font-medium transition'>Follow Us</button>
                ...
                <div className='flex justify-between gap-x-3'>
                    <div className='flex relative overflow-hidden z-0 flex-col group justify-center items-center transition-all duration-300 rounded-xl   px-4 bg-white'>
                        ...
                        <p className='text-4xl group-hover:text-white'>83</p>
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg h-fit">
                            ...
                            <div className="space-y-2 ">
                                ...
                                <div className="grid grid-cols-12">
                                    ...
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">Design & Software</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Since</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">1996</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Views</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">568+</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Reviews</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">(4.8)</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Total Jobs</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">68+</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Location</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">New York, Chittagong</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Phone</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">+0053336622</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Email</span>
                                    <span>:</span>
                                    <span className="text-green-600 font-medium whitespace-nowrap col-span-5">yourmail@gmail.com</span>
                                </div>
