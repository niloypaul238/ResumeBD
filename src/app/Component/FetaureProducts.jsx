    ...
    return (
        <div className='bg-gray-100'>
            <div className='w-10/12 mx-auto  '>
                <p className='text-3xl text-center pt-15'>Recent Job Circulars</p>
                            ...
                            return (
                                <div key={job.id} className="max-w-sm bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link href={`/all_jobs/${job.id}`} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md font-medium transition">
                                            Apply Now
                                        </Link>
                                    </div>
